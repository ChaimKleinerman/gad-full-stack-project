...
const data = {
    products: [
        ...
        },
        {
            ...
            description:
                "Original Al Munakh®️ by Mahal Al Musk | Our Impression of Climate | 6ml Non-Alcoholic Concentrated Perfume Oil",
            price: 120,
        ...
        },
        {
            ...
            description:
                "L'OrÃ©️al Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic Acid",
            price: 19,
...
const remove = (data: Data) => {
    for (let i = 0; i < data.products.length; i++) {
        ...
        // Generate random coordinates for each product
        data.products[i].coordinates = {
            latitude: getRandomCoordinate(),
            longitude: getRandomCoordinate(),
            latitude2: getRandomCoordinate(), // Add another latitude
            longitude2: getRandomCoordinate(), // Add another longitude
        };
    }
};
const getRandomCoordinate = () => {
    const min = -90; // Minimum latitude/longitude
    const max = 90; // Maximum latitude/longitude
    return Math.random() * (max - min) + min;
};
remove(data)
// Function to generate a random coordinate within a specific range
