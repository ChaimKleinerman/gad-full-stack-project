...
const controller_allData = async (req, res) => {
    try {
...
const controller_allCategories = async (req, res) => {
    try {
...
const controller_dataByCategory = async (req, res) => {
    try {
...
const controller_userRegister = async (req, res) => {
    try {
