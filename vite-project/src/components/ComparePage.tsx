...
import { emptyProduct } from './saveProd2ForCompare';
// import { restartProductsValues } from './saveProd2ForCompare';
...
export function CompareProducts() {
    ...
    return (
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableBody>
                    ...
                    <TableCell align='left'>
                        <img src={product1.images![0]} alt='product image' style={{width: '150px', height: '150px'}}/>
                    </TableCell>
                    <TableCell align='left'>
                        <img src={product2.images![0]} alt='product image' style={{width: '150px', height: '150px'}}/>
                    </TableCell>
                    </TableRow>
                    <TableRow
                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
        ...
        <button onClick={restartProductsValues}>restart values</button>
        </>
    );
}
